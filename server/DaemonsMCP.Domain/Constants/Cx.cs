...
namespace DaemonsMCP.Domain.Constants {
  public static class Cx {
    ...
    public const string ListFileSystemDesc = "Searches the file system index for files and folders matching the filters provided. Both folder and file filters are optional, if not provided all files and folders are returned.  Search is db table like list of results.";
    ...
    public const string SearchIncludeFiles = "bool should results include files";
