...
namespace DaemonsMCP.Infrastructure.Migrations
{
    ...
    [Migration("20251227024119_AddReposBranchesForGitx2")]
    partial class AddReposBranchesForGitx2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DaemonsMCP.Domain.Entities.ProjectRepository", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProjectId")
                        .HasDatabaseName("IX_ProjectRepositories_ProjectId");

                    b.HasIndex("UserCredentialId")
                        .HasDatabaseName("IX_ProjectRepositories_UserCredentialId");

                    b.HasIndex("ProjectId", "LocalPath")
                        .IsUnique()
                        .HasDatabaseName("UQ_ProjectRepositories_ProjectPath");
            ...
            modelBuilder.Entity("DaemonsMCP.Domain.Entities.GitBranch", b =>
                {
                    ...
                    b.HasIndex("ProjectRepositoryId")
                        .HasDatabaseName("IX_RepositoryBranches_ProjectRepositoryId");

                    b.HasIndex("ProjectRepositoryId", "FullName")
                        .IsUnique()
                        .HasDatabaseName("UQ_RepositoryBranches_UniqueName");

                    b.HasIndex("ProjectRepositoryId", "IsCurrentBranch")
                        .HasDatabaseName("IX_RepositoryBranches_IsCurrentBranch")
            ...
            modelBuilder.Entity("DaemonsMCP.Domain.Entities.GitBranch", b =>
                {
                    b.HasOne("DaemonsMCP.Domain.Entities.ProjectRepository", "ProjectRepository")
                        .WithMany("Branches")
