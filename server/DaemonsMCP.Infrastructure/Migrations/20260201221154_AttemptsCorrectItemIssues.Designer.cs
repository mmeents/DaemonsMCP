...
namespace DaemonsMCP.Infrastructure.Migrations
{
    ...
    [Migration("20260201221154_AttemptsCorrectItemIssues")]
    partial class AttemptsCorrectItemIssues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DaemonsMCP.Domain.Entities.ModelProperty", b =>
                {
                    ...
                    b.Property<int?>("PropertyEditorTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PropertyEditorTypeId");
            ...
            modelBuilder.Entity("DaemonsMCP.Domain.Entities.ModelProperty", b =>
                {
                    ...
                    b.HasOne("DaemonsMCP.Domain.Entities.ModelType", "PropertyEditorType")
                        .WithMany()
                        .HasForeignKey("PropertyEditorTypeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DaemonsMCP.Domain.Entities.ModelType", "PropertyValueType")
                        .WithMany()
                    ...
                    b.Navigation("PropertyEditorType");
