...
namespace DaemonsMCP.Core.Services {
  ...
  public interface IClassService {
    public Task<OperationResult> GetClassesAsync(string projectName, int pageNo =1, int itemsPerPage = 20, string? namespaceFilter = null, string? classNameFilter = null);
    ...
    public Task<OperationResult> GetMethodsAsync(string projectName, int pageNo=1, int itemsPerPage=20, string? namespaceFilter = null, string? classNameFilter = null, string? methodNameFilter = null);
