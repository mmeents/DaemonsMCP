   ...
   public static class MimeTypesMap
    {
        ...
        private static readonly Lazy<Dictionary<string, string>> _mimeTypeMap = new Lazy<Dictionary<string, string>>(() => new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["asm"] = "text/x-asm",
            ["aspx"] = "text/x-aspx",
            ["master"] = "text/x-master",
            ["c"] = "text/x-c",
            ["cc"] = "text/x-c",
            ["cs"] = "text/x-cs",
            ["csproj"] = "text/x-csproj",
        ...
        public static string DetectFileEncoding(string filePath)
        {
            ...
            {
                fs.Read(buffer, 0, Math.Min(4, (int)fs.Length));
            }
            ...
            // Fallback: Try to read as UTF-8 (common default for text files)
            try
            {
                using (StreamReader reader = new StreamReader(filePath, Encoding.UTF8, true))
                {
                    reader.Peek(); // Force encoding detection
                    return reader.CurrentEncoding.WebName; // Returns detected or fallback encoding
                }
            }
            catch
            {
                // If UTF-8 fails, assume ANSI (e.g., Windows-1252) as a last resort
                return "windows-1252";
            }
        }
        ...
        public static bool IsBinaryFile(string filePath){ 
            ...
            {
                // If file cannot be read, assume it is binary
                return true;
            }
